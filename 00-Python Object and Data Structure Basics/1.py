...
def convert_listof_dict():
    l1 = [{'name': 'insights', 'type': 'INTEGER'}, {'name': 'changestatus', 'type': 'STRING'},
          {'name': 'isdebug', 'type': 'BOOLEAN'}
        , {'name': 'feedbased', 'type': 'BOOLEAN'}, {'name': 'linkedcount', 'type': 'INTEGER'},
          {'mode': 'REPEATED', 'name': 'linkedincidents', 'type': 'INTEGER'}, {'name': 'parent', 'type': 'STRING'},
          {'name': 'notifytime', 'type': 'TIMESTAMP'}
        , {'name': 'rawclosereason', 'type': 'STRING'}, {'name': 'openduration', 'type': 'INTEGER'}
        , {'name': 'attachment', 'type': 'STRING'},
          {'fields': [{'name': 'type', 'type': 'STRING'}, {'name': 'value', 'type': 'STRING'}], 'mode': 'REPEATED',
           'name': 'labels', 'type': 'RECORD'}
        , {'name': 'closed', 'type': 'TIMESTAMP'}, {'name': 'reason', 'type': 'STRING'},
          {'name': 'rawname', 'type': 'STRING'}, {'name': 'rawtype', 'type': 'STRING'}
        , {'name': 'autime', 'type': 'INTEGER'}, {'name': 'account', 'type': 'STRING'},
          {'name': 'cacheversn', 'type': 'INTEGER'}
        , {'name': 'version', 'type': 'INTEGER'}, {'name': 'readonlyroles', 'type': 'STRING'},
          {'name': 'vulcanmode', 'type': 'STRING'}
        ...
        , {'name': 'heaptarget', 'type': 'STRING'}, {'name': 'dbotstatus', 'type': 'STRING'},
          {'name': 'dbotmirrorlastsync', 'type': 'TIMESTAMP'}
        ...
        , {'name': 'dbotduedate', 'type': 'TIMESTAMP'}, {'name': 'dbotcreatedby', 'type': 'STRING'},
          {'name': 'closinguserid', 'type': 'STRING'}, {'name': 'lastopen', 'type': 'TIMESTAMP'},
          {'name': 'closereason', 'type': 'STRING'}
        , {'name': 'frameworkphase', 'type': 'STRING'}, {'name': 'dbottotaltime', 'type': 'TIMESTAMP'}
        , {'mode': 'REPEATED', 'name': 'botunsubscribedusers', 'type': 'STRING'},
          {'mode': 'REPEATED', 'name': 'botreporttable', 'type': 'STRING'}
        , {'mode': 'REPEATED', 'name': 'xsiambotemailcommunication', 'type': 'STRING'}
        , {'fields': [{'name': 'value', 'type': 'STRING'}, {'name': 'total', 'type': 'INTEGER'}], 'mode': 'REPEATED',
           'name': 'useremail', 'type': 'RECORD'}
          ]
    print(l1)
